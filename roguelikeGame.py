...
def roguelikeGameMain():
    ...
    class Sound:
        ...
        pygame.mixer.music.load(
            os.path.join(SOUND_PATH, "junglemusic.wav")
    ...
    class Floor:
        groundImage = loadTexture(
            f"ground{random.randint(1, 3)}.png", 16 * 32, 16 * 32
        ).convert()
        tutorialGroundImage = loadTexture(
            "tutorialGround.png", 16 * 32, 16 * 32
        ).convert()
    ...
    class Boss(Enemy):
        ...
        def __init__(self, x, y):
            ...
            pygame.mixer.music.load(
                os.path.join(SOUND_PATH, "bosstheme.wav")
            )  # Load the new song
    ...
    roomPresets = [
        [
            ...
            [
                createF(
                    ...
                    100,
                    100,
                    lootTable=[Spirality, Saw, Svamp, Tnt],
                    occurance=0.5,
                ),
                createF([Animus, Pufferfish, Skull, Saw, Svamp], 250, 250),
                createF([Animus, Pufferfish, Skull, Saw, Sledger], 250, 250, depth=3),
                createF(
                    [Animus, Pufferfish, Robot, Skull, Saw, Schmitt], 250, 250, depth=5
                ),
                createF(
                    [Animus, Pufferfish, Robot, Skull, Saw, Hjuldjur],
        ...
        [
            ...
            [
                ...
                createF(
                    [Hjuldjurplant, BlazeSpitter, Svamp],
                    300,
                    350,
                    occurance=0.3,
                    depth=4,
